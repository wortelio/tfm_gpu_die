...
class MobileNetV3_Small(nn.Module):
    def __init__(self, num_classes=1000, act=nn.Hardswish):
        ...
        self.bneck = nn.Sequential(
            ...
            Block(3, 16, 32, 24, nn.ReLU, False, 2),
            Block(3, 24, 48, 24, nn.ReLU, False, 1),
            Block(5, 24, 64, 32, act, True, 2),
            Block(5, 32, 128, 32, act, True, 1),
            Block(5, 32, 128, 40, act, True, 1),
            Block(5, 40, 96, 48, act, True, 1),
            # Block(5, 48, 112, 48, act, True, 1),
        ...
        self.conv2 = nn.Conv2d(48, 64, kernel_size=1, stride=1, padding=0, bias=False)
