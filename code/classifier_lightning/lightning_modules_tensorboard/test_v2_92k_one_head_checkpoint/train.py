...
from callbacks import lr_monitor, checkpoint_callback
...
logger.info('BED Classifier with Pytorch Lightning. Code Reestructured in modules. Reduced version One Head, 92K weights.')
logger.info('Model Checkpoint added.')
...
def main():
    ...
    tb_logger = TensorBoardLogger("tb_logs", name="bed_model_v2_one_head")
