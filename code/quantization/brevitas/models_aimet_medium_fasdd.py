    ...
    def __create_BED__(self):
        BED_model = nn.Sequential(
            ...
            # Conv2d [in_channels, out_channels, kernel_size, stride, padding, bias]
                    ...
                    ("conv2", nn.Sequential(
                        nn.Conv2d(32, 19, kernel_size=(3, 1), stride=(1, 1), padding=(1,0), bias=False),
                        nn.Conv2d(19, 14, kernel_size=(1, 3), stride=(1, 1), padding=(0,1)) ),
                    ),
                    ("relu2", nn.ReLU()),
                    ...
                    ("conv31", nn.Sequential(
                        nn.Conv2d(14, 6, kernel_size=1, stride=1, padding=0, bias=False),
                        nn.Conv2d(6, 11, kernel_size=1, stride=1, padding=0) ),
                    ),                     
                    ("relu31", nn.ReLU()),
                    
                    ("conv32", nn.Conv2d(11, 32, kernel_size=3, stride=1, padding=1) ),
                    ("relu32", nn.ReLU()),
                    ...
                    ("conv34", nn.Sequential(
                        ...
                        nn.Conv2d(45, 57, kernel_size=(1, 3), stride=(1, 1), padding=(0,1)) ),
                    ),
                    ("relu34", nn.ReLU()),
                    ...
                    ("conv44", nn.Conv2d(32, 57, kernel_size=3, stride=1, padding=1)),
                    ("relu44", nn.ReLU()),
                    
                    ("conv45", nn.Sequential(
                        nn.Conv2d(57, 17, kernel_size=1, stride=1, padding=0, bias=False),
                        nn.Conv2d(17, 32, kernel_size=1, stride=1, padding=0) ),
                    ),
                    ("relu45", nn.ReLU()),
                    
                    ("conv46", nn.Sequential(
                        nn.Conv2d(32, 5, kernel_size=(3, 1), stride=(1, 1), padding=(1,0), bias=False),
                        nn.Conv2d(5, 64, kernel_size=(1, 3), stride=(1, 1), padding=(0,1)) ),
                    ),
                    ("relu46", nn.ReLU()),
                ...
                [   
                    ...
                    ("conv34", nn.Sequential(             
                         ...
                         qnn.QuantConv2d(
                                45, 57, 
                                kernel_size=(1, 3), stride=1, padding=(0, 1), 
                                weight_bit_width=self.big_layers_weight_bw,#self.weight_bw,
                                weight_quant=MyInt8Weight,
                                bias=True,
                                bias_quant=MyIntBias))), 
