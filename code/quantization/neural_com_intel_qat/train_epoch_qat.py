...
def train_fn(loader, model, optimizer, loss_fn, device, cmp_mng):
    ...
    for batch_idx, (x, y) in enumerate(loop):
        ...
        #****************** Quantization ******************#
        cmp_mng.callbacks.on_step_begin(batch_idx)
        #**************************************************#
        ...
        #print(type(train_loss)) #BUG: callback changes loss into list
        #train_loss = cmp_mng.callbacks.on_after_compute_loss(x, out, train_loss)
        ...
        cmp_mng.callbacks.on_before_optimizer_step()
        optimizer.step()
        cmp_mng.callbacks.on_step_end()
