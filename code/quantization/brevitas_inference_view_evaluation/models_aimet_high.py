...
#class MyIntBias(Int32Bias):    
    ...
    """
    bit_width = config.HIGH_COMP_BIAS_BIT_WIDTH
    #pass
...
# ______________________________________________________________ #
class ORIGINAL_PRUNING_AFTER_SVD_CLASSIFIER(nn.Module):
    def __init__(self, num_classes, in_channels=3):
        super(ORIGINAL_PRUNING_AFTER_SVD_CLASSIFIER, self).__init__()
        ...
        BED_model = nn.Sequential(
            ...
            # Conv2d [in_channels, out_channels, kernel_size, stride, padding, bias]
                    ...
                    ("conv2", nn.Sequential(
                        ...
                        nn.Conv2d(6, 16, kernel_size=(1, 3), stride=(1, 1), padding=(0,1)) ),
                    ),
                    ("relu2", nn.ReLU()),
                    ...
                    ("conv31", nn.Conv2d(16, 14, kernel_size=1, stride=1, padding=0)),
                    ("relu31", nn.ReLU()),
                    
                    ("conv32", nn.Sequential(
                        nn.Conv2d(14, 16, kernel_size=(3, 1), stride=(1, 1), padding=(1,0), bias=False),
                    ...
                    ("conv34", nn.Sequential( 
                        nn.Conv2d(32, 30, kernel_size=(3, 1), stride=(1, 1), padding=(1,0), bias=False),
                        nn.Conv2d(30, 64, kernel_size=(1, 3), stride=(1, 1), padding=(0,1)) ),
                    ),
                    ("relu34", nn.ReLU()),
                    ...
                    ("conv44", nn.Sequential(
                        nn.Conv2d(32, 39, kernel_size=(3, 1), stride=(1, 1), padding=(1,0), bias=False),
                        nn.Conv2d(39, 64, kernel_size=(1, 3), stride=(1, 1), padding=(0,1)) ),
                    ),               
                    ("relu44", nn.ReLU()),
...
# __________________    PRUNING AFTER SVD     __________________ #
# ______________________________________________________________ #
class QUANT_PRUNING_AFTER_SVD_CLASSIFIER(nn.Module):
    def __init__(self, num_classes, 
                 ...
                 bias_bw, 
                 in_channels=3):
        super(QUANT_PRUNING_AFTER_SVD_CLASSIFIER, self).__init__()
        self.in_channels = in_channels
        self.last_channels = 64
        self.num_classes = num_classes
...
# ______________________________________________________________ #
# __________________    SVD AFTER PRUNING     __________________ #
# ______________________________________________________________ #
class QUANT_SVD_AFTER_PRUNING_CLASSIFIER(nn.Module):
    def __init__(self, num_classes, 
                 weight_bw, 
                 big_layers_weight_bw,
                 act_bw, 
                 bias_bw, 
                 in_channels=3):
        super(QUANT_SVD_AFTER_PRUNING_CLASSIFIER, self).__init__()
        self.in_channels = in_channels
        self.last_channels = 64
        self.num_classes = num_classes
