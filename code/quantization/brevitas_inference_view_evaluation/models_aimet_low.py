...
#class MyIntBias(Int32Bias):    
    ...
    """
    bit_width = config.LOW_COMP_BIAS_BIT_WIDTH
    #pass
...
# ______________________________________________________________ #
class ORIGINAL_SOFT_PRUNING_AFTER_SVD_CLASSIFIER(nn.Module):
    def __init__(self, num_classes, in_channels=3):
        super(ORIGINAL_SOFT_PRUNING_AFTER_SVD_CLASSIFIER, self).__init__()
    ...
    def __create_BED__(self):
        BED_model = nn.Sequential(
            ...
            # Conv2d [in_channels, out_channels, kernel_size, stride, padding, bias]
                    ...
                    ("conv2", nn.Sequential(
                        nn.Conv2d(22, 7, kernel_size=(3, 1), stride=(1, 1), padding=(1,0), bias=False),
                        nn.Conv2d(7, 14, kernel_size=(1, 3), stride=(1, 1), padding=(0,1)) ),
                    ),
                    ("relu2", nn.ReLU()),
                    ...
                    ("conv31", nn.Conv2d(14, 14, kernel_size=1, stride=1, padding=0)),
                    ("relu31", nn.ReLU()),
                    
                    ("conv32", nn.Sequential(
                        nn.Conv2d(14, 22, kernel_size=(3, 1), stride=(1, 1), padding=(1,0), bias=False),
                        nn.Conv2d(22, 28, kernel_size=(1, 3), stride=(1, 1), padding=(0,1)) ),
                    ),
                    ("relu32", nn.ReLU()),
                    
                    ("conv33", nn.Conv2d(28, 32, kernel_size=1, stride=1, padding=0)),
                    ("relu33", nn.ReLU()),
                    ...
                    ("conv46", nn.Sequential(
                        nn.Conv2d(32, 7, kernel_size=(3, 1), stride=(1, 1), padding=(1,0), bias=False),
                        nn.Conv2d(7, 64, kernel_size=(1, 3), stride=(1, 1), padding=(0,1)) ),
                    ),
                    ("relu46", nn.ReLU()),
...
# __________________    PRUNING AFTER SVD     __________________ #
# ______________________________________________________________ #
class QUANT_SOFT_PRUNING_AFTER_SVD_CLASSIFIER(nn.Module):
    def __init__(self, num_classes, 
                 ...
                 bias_bw, 
                 in_channels=3):
        super(QUANT_SOFT_PRUNING_AFTER_SVD_CLASSIFIER, self).__init__()
        self.in_channels = in_channels
        self.last_channels = 64
        self.num_classes = num_classes
            ...
            collections.OrderedDict(
                [   
                    ...
                    ("conv34", qnn.QuantConv2d(32, 64, 
                                kernel_size=3, stride=1, padding=1, 
                                weight_bit_width=2,#self.big_layers_weight_bw,
                                weight_quant=MyInt8Weight,
                                bias=True, 
                                bias_quant=MyIntBias)),
