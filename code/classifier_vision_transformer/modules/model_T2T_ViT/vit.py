...
from modules.model_T2T_ViT.attention import Attention
from modules.model_T2T_ViT.position_embedding import get_sinusoid_encoding
...
class ViT_Backbone(nn.Module):
    def __init__(self,
        ...
        #self.cls_token.weight.data.normal_(0, 0.02) # Changed by Wortel to avoid Timm import
...
class ViT_Model(nn.Module):
    ...
    def _init_weights(self, m):
        ...
        if isinstance(m, nn.Linear):
            ...
            m.weight.data.normal_(0, 0.02) # Changed by Wortel to avoid Timm import
