...
class CNV_w1a1_DEEP_Resnet_V6(Module):
    ...
    def __init__(self, 
                 ...
                 in_bit_width=8, 
                 in_channels=3):
        super(CNV_w1a1_DEEP_Resnet_V6, self).__init__()
        ...
        #         bit_width=act_bit_width, 
        #         return_quant_tensor=self.return_quant_tensor))
        self.conv_features_3_1.append(QuantReLU(
                act_quant=CommonUintActQuant,
                bit_width=4, 
                restrict_scaling_type = RestrictValueType.POWER_OF_TWO, 
                return_quant_tensor=self.return_quant_tensor))
        ...
        self.relu_conv_3_1 = QuantReLU(
                act_quant=CommonUintActQuant,
                bit_width=4, 
                restrict_scaling_type = RestrictValueType.POWER_OF_TWO, 
                return_quant_tensor=self.return_quant_tensor_add_pool)
        self.conv_features_3_1.append(self.relu_conv_3_1) # Added for Residual Again

        ### Not needed, as residual has been removed in following branch
        # self.conv_features_3_1.append(
        #     QuantIdentity(
        #         act_quant=CommonActQuant,
        #         bit_width=act_bit_width, 
        ...
        self.conv_features_4_0.append(
            QuantReLU(
                act_quant=self.relu_conv_3_1.act_quant, #CommonUintActQuant,
                bit_width=4, 
                restrict_scaling_type = RestrictValueType.POWER_OF_TWO, 
                return_quant_tensor=self.return_quant_tensor_add_pool))
