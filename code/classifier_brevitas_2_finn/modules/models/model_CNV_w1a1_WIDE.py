...
class CNV_w1a1_WIDE(Module):
    ...
    def __init__(self, 
                 ...
                 in_bit_width=8, 
                 in_channels=3):
        super(CNV_w1a1_WIDE, self).__init__()
        ...
        self.conv_features.append(
            QuantConv2d(
                ...
                weight_quant=CommonWeightQuant,
                weight_bit_width=weight_bit_width))
        self.conv_features.append(BatchNorm2d(24, eps=1e-4))
        self.conv_features.append(
            QuantIdentity(
                act_quant=CommonActQuant,
                bit_width=act_bit_width, 
        ...
        self.conv_features.append(
            QuantConv2d(
                ...
                weight_quant=CommonWeightQuant,
                weight_bit_width=weight_bit_width))
        self.conv_features.append(BatchNorm2d(128, eps=1e-4))
        self.conv_features.append(
            QuantIdentity(
                act_quant=CommonActQuant,
                bit_width=act_bit_width, 
        ...
        self.conv_features.append(
            QuantConv2d(
                ...
                weight_quant=CommonWeightQuant,
                weight_bit_width=weight_bit_width))
        self.conv_features.append(BatchNorm2d(256, eps=1e-4))
        self.conv_features.append(
            QuantIdentity(
                act_quant=CommonActQuant,
                bit_width=act_bit_width, 
       ...
       # Average Pooling
        ...
        self.linear_features.append(
            QuantLinear(
                ...
                weight_bit_width=4))
        self.linear_features.append(BatchNorm1d(128, eps=1e-4))
        self.linear_features.append(
            QuantIdentity(
