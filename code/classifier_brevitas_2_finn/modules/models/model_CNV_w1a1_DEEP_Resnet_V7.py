...
class CNV_w1a1_DEEP_Resnet_V7(Module):
    ...
    def __init__(self, 
                 ...
                 in_bit_width=8, 
                 in_channels=3):
        super(CNV_w1a1_DEEP_Resnet_V7, self).__init__()
        ...
        self.conv_features_4_0.append(QuantReLU(
                act_quant=CommonUintActQuant,
                bit_width=4, 
                restrict_scaling_type = RestrictValueType.POWER_OF_TWO, 
                return_quant_tensor=self.return_quant_tensor))
        ...
        ### Not needed if lasyers before end with 1x1x128
        # Average Pooling
