...
class BED_AIMET_FPGA_MANUAL(nn.Module):
    def __init__(self, num_classes=2, 
                 in_bit_width=8,
                 weight_bit_width=4,
                 act_bit_width=4):
        super(BED_AIMET_FPGA_MANUAL, self).__init__()

        self.cfgs = [
            # [conv3x3/svd_conv3x3/conv1x1/svd_conv1x1/mp, (inp, mid(opt), oup)]
            ["conv3x3", (3, 12)],                      # conv1
            ["mp"],
            ["svd_conv3x3", (12, 20, 16)],             # conv2
            ["mp"],
            ["conv1x1", (16, 16)],                     # conv31
            ["svd_conv3x3", (16, 20, 32)],             # conv32
            ["conv1x1", (32, 32)],                     # conv33
            ["svd_conv3x3", (32, 40, 64)],             # conv34
            ["mp"],
            ["conv1x1", (64, 32)],                     # conv41
            ["conv3x3", (32, 56)],                     # conv42
            ["conv1x1", (56, 32)],                     # conv43
            ["svd_conv3x3", (32, 40, 56)],             # conv44
            ["conv1x1", (56, 32)],                     # conv45
            ["svd_conv3x3", (32, 20, 64), "last"],     # conv46            
        ]
        ...
        for l in self.linear_cfg:
            linears.extend(linear_layers(in_neurons, l, weight_bit_width, act_bit_width))  
            in_neurons = l
