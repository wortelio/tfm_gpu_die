...
class MobileNetV2_MINI_RESNET_V3(nn.Module):
    def __init__(self, num_classes=2, width_mult=1.):
        super(MobileNetV2_MINI_RESNET_V3, self).__init__()
        ...
        self.conv_final_1 = conv_1x1_bn(input_channel, 96)
        ...
        self.conv_final_2 = conv_1x1_bn(96, output_channel)
