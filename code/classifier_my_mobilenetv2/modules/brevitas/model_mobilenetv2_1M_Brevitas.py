...
class MobileNetV2_1M(nn.Module):
    def __init__(self, num_classes=2, 
                 width_mult=1., 
                 in_bit_width=8,
                 weight_bit_width=1,
                 act_bit_width=1):
        super(MobileNetV2_1M, self).__init__()
        ...
        output_channel = _make_divisible(640 * width_mult, 4 if width_mult == 0.1 else 8) if width_mult > 1.0 else 640
